...
if __name__ == '__main__':
    ...
    for k, p in test_kernel_padding:
        acb = RepVGGBlock(3, 64, kernel_size=k, padding=p, stride=1, deploy=False)
        acb.eval()
        ...
        deployout = acb(x)
        print('difference between the outputs of the training-time and converted RepVGGBlock is')
        print(((deployout - out)**2).mean())
